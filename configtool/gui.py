...
class ConfigFrame(wx.Frame):
    def __init__(self, settings):
        ...
        self.nb = wx.Notebook(
            panel, wx.ID_ANY, size=(880, 550), style=wx.BK_DEFAULT
        )
    ...
    def makeMenu(self):
        ...
        file_menu.Append(
            ID_SAVE_PRINTER, "Save printer", "Save printer configuration."
        )
        ...
        self.Bind(
            wx.EVT_MENU, self.onSavePrinterConfigAs, id=ID_SAVE_PRINTER_AS
        )
        ...
        file_menu.Append(
            ID_SAVE_BOARD, "Save board", "Save board configuration."
        )
    ...
    def onAbout(self, evt):
        ...
        self.message(
            ...
            "    Markus Hitter (866 commits)\n"
            "    Michael Moon (316 commits)\n"
            "    Nico Tonnhofer (133 commits)\n"
            "    Phil Hord (115 commits)\n"

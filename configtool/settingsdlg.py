...
class SettingsDlg(wx.Dialog):
    def __init__(self, parent, settings):
        wx.Dialog.__init__(
            self, parent, wx.ID_ANY, "Modify settings", size=(500, 300)
        )
        ...
        htMinAdc = (
            "The minimum ADC value returned by the thermistor. Typically 0."
        )
        htMaxAdc = (
        ...
        htT0 = (
            "The T0 value used for thermistor table calculation. Typically 25."
        )
        htR1 = (
            "The R1 value used for thermistor table calculation. Typically 0."
        )
